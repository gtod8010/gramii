...
export async function PATCH(
  ...
  try {
    ...
    // A user can change their own password, or an admin can change any password.
    if (decoded.role !== 'admin') {
      // Regular user needs to provide current password
      ...
      // Admin does not need currentPassword
      if (!newPassword) {
